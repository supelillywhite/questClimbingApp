...
class QuestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post quests_url, params: { quest: { description: @quest.description, gear: @quest.gear, picture: @quest.picture, title: @quest.title } }
    end
  ...
  test "should update quest" do
    patch quest_url(@quest), params: { quest: { description: @quest.description, gear: @quest.gear, picture: @quest.picture, title: @quest.title } }
